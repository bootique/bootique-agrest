...
@BQTest
public class AgrestModule_SkipNullProperties_IT {
    ...
    static final BQRuntime app = Bootique
            ...
            .module(b -> AgrestModule.extend(b).skipNullProperties())
    ...
    public static class R1 {
        ...
        public DataResponse<E1> get(@Context UriInfo uriInfo) {
            return AgJaxrs
                    ...
                    .entityOverlay(AgEntity.overlay(E1.class).dataResolver(AgrestModule_SkipNullProperties_IT::fillData))
                    .get();
        }
    }
